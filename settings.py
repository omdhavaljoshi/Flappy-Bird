...
sign_out_button2 = pygame.Rect(width-350,height-500,200,60)
play_button = pygame.Rect(width-350,height-600,200,60)
difficulty_button = pygame.Rect(width-350,height-400,200,60)
menu_button = pygame.Rect(width-350,height-100,200,60)
menu_button2 = pygame.Rect(width-350,height-400,200,60)
# images ->
...
play_img = os.path.join(dir,r"Images/play.png")
difficulty_img = os.path.join(dir,r"Images/difficulty.png")
menu_img = os.path.join(dir,r"Images/menu.png")
# button images ->
...
play_btn_img = pygame.image.load(play_img)
play_btn_img = pygame.transform.scale(play_btn_img,(200,60))
difficulty_btn_img = pygame.image.load(difficulty_img)
difficulty_btn_img = pygame.transform.scale(difficulty_btn_img,(200,60))
menu_btn_img = pygame.image.load(menu_img)
menu_btn_img = pygame.transform.scale(menu_btn_img,(200,60))
# input boxes ->
